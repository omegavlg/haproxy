...
1. `Настроим балансировку на 7 уровне и пробуем обратиться к HAproxy`
<img src = "img/008.png" width = 50%>

2. `Произведем настройку HAproxy, чтобы он мог балансировать только тот http-трафик, который адресован домену example.local и пробуем к нему обратиться c использованием домена example.local и без него:`
<img src = "img/006.png" width = 50%>
<img src = "img/007.png" width = 50%>

3. Добавим TCP-балансировку и обратимся к HAProxy`
<img src = "img/009.png" width = 50%>

4. `Итоговый конфигурационный файл для 2-го задания:`
